...
| Experimental software | [MIT](http://opensource.org/licenses/MIT) `r format(Sys.Date(), "%Y")` Ernst-August Doelle |
| Data                  | [CC-0](http://creativecommons.org/publicdomain/zero/1.0/) attribution requested in reuse |
| Analysis code         | [MIT](http://opensource.org/licenses/MIT) `r format(Sys.Date(), "%Y")` Ernst-August Doelle |
